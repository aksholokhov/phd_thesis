...
with the \texttt{scikit-learn} standard. 
...
This extension and its mathematical foundations in \cite{aravkin2022jimtheory} constitute
...
%highly technical 
mathematical 
foundations are presented in \cite{aravkin2022jimtheory}.
...
computed in~\cite[Section 5.1]{aravkin2022jimtheory} . The expected value of the posterior mode $\beta$ given $\Gamma$ has the closed form representation 
...
Standalone proofs for the existence of minimizers are developed in~\cite[Theorem 1]{aravkin2022jimtheory},
and extended to the presence of regularizers in~\cite[Theorem 2]{aravkin2022jimtheory}. %, restated below for convenience. 
...
%\end{theorem}
%
%Feature selection methods  include sparsity-inducing penalties or constraints. See~\cite[Theorem 1]{aravkin2022jimtheory}
...
%\]  
By \cite[Theorem 2]{aravkin2022jimtheory}, solutions to \eqref{eq:lme_loss_original_in_x}
...
computed in~\cite[Section 5.1]{aravkin2022jimtheory}.
...
Indeed, in \cite[Section 5]{aravkin2022jimtheory} it is shown that 
...
The results in \cite{aravkin2022jimtheory} show that all components of the iteration~(\ref{eq:pgd_for_value_function}) are well-defined. 
...
In \cite[Theorem 6]{aravkin2022jimtheory}, it is shown that
...
\cite[Lemma 3]{aravkin2022jimtheory} that
\[
...
\begin{table}[h]
\centering
\resizebox{\columnwidth}{!}{\input{tables/table_glmm_current.tex}}
...
\begin{table}[ht]
	\centering
    \resizebox{\columnwidth}{!}{\input{tables/scaling_time.tex}}
...
\begin{table}[ht]
	\centering
    \input{tables/central_path_time.tex}
...
\begin{table}[ht]
	\centering
    %\resizebox{\columnwidth}{!}{}
    \input{tables/central_path_acc.tex}
...
To ensure reproducibility of this research, all new algorithms have been implemented as a part of the \texttt{pysr3}\footnote{Available at \href{https://github.com/aksholokhov/pysr3}{https://github.com/aksholokhov/pysr3}} library~(\cite{sholokhov2023pysr3}). This library implements functionality for fitting linear mixed models and selecting covariates. The user interface was designed to be fully compliant with the standards\footnote{\href{https://scikit-learn.org/stable/developers/develop.html}{https://scikit-learn.org/stable/developers/develop.html}} of \texttt{scikit-learn} library to minimize learning time. 
